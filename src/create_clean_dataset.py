...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Clean Logos In The Wild dataset"
    )
    parser.add_argument(
        "--in",
        dest="inpath",
        help="Path of the original dataset's data folder to be cleaned. It won't be modified.",
        default=None,
        type=str,
        required=True,
    )
    ...
    for subdir_counter, (r, subdirs, files) in enumerate(os.walk(xmlpath)):
        ...
        for filename in files:
            ...
            if (not os.path.isfile(imgpath)) or (im is None):
                ...
                print(
                    "Deleted xml for unavailable image file {:s}".format(
                        imgpath
                    )
                )
                continue
            ...
            os.rename(
                ...
                os.path.join(r, new_imagename + ".xml"),
            )
            filename = new_imagename + ".xml"
            filewithpath = os.path.join(r, filename)
            os.rename(
                os.path.join(r, imagename + ext),
                os.path.join(r, new_imagename + ext),
            )
            ...
            for obj in root.findall("object"):
                ...
                if (
                    brand == "mercedes-schrift"
                    or brand == "mercedes-schriftzug"
                ):
                ...
                if (
                    brand == "the home depot1"
                    or brand == "the home depot-logo"
                ):
                    brand = "thehomedepot"
                if "vl" in brand:
                ...
                if (
                    roiname == "H&M_img000198_0"
                    or roiname == "H&M_img000252_4"
                ):
                    brand = "adidas3"
                if (
                    roiname == "nivea_img000135_0"
                    or roiname == "nivea_img000180_5"
                    or roiname == "red bull_img000292_2"
                    or roiname == "red bull_img000292_9"
                    or roiname == "red bull_img000323_3"
                    or roiname == "red bull_img000563_2"
                    or roiname == "red bull_img000563_4"
                ):
                    brand = "adidas-text"
                if (
                    brand == "adidas"
                    or brand == "adidas-symbol"
                    or roiname == "adidas_img000419_0"
                ):
                    brand = "adidas1"
                ...
                if brand == "amazon-text":
                    brand = "amazon"
                if (
                    roiname == "boeing_img000039_2"
                    or roiname == "boeing_img000043_1"
                ):
                    brand = "amazon"
                ...
                if (
                    roiname == "budweiser_img000008_5"
                    or roiname == "budweiser_img000008_6"
                    or roiname == "budweiser_img000008_7"
                    or roiname == "budweiser_img000008_8"
                    or roiname == "budweiser_img000009_0"
                    or roiname == "budweiser_img000177_5"
                    or roiname == "budweiser_img000177_6"
                    or roiname == "budweiser_img000177_7"
                    or roiname == "budweiser_img000202_0"
                    or roiname == "budweiser_img000210_3"
                    or roiname == "budweiser_img000210_4"
                    or roiname == "budweiser_img000376_4"
                    or roiname == "budweiser_img000376_5"
                    or roiname == "budweiser_img000376_7"
                ):
                    brand = "budweiser-text"
                if (
                    roiname == "burger king_img000172_0"
                    or roiname == "McDonalds_img000594_1"
                ):
                    brand = "burgerking-text"
                if (
                    roiname == "burger king_img000131_2"
                    or roiname == "burger king_img000420_1"
                    or roiname == "burger king_img000166_3"
                ):
                    brand = "burgerking-symbol"
                if brand == "burkler":
                    brand = "buckler"
                ...
                if roiname == "nivea_img000128_3":
                    brand = "nivea"
                if (
                    roiname == "Pampers_img000016_1"
                    or roiname == "Pampers_img000144_2"
                ):
                    brand = "pampers"
                if (
                    roiname == "philips_img000069_1"
                    or roiname == "philips_img000155_8"
                ):
                    brand = "philips"
                ...
                if roiname == "sony_img000014_0":
                    brand = "sony"
                if (
                    roiname == "volkswagen_img000042_5"
                    or roiname == "volkswagen_img000105_1"
                ):
                    brand = "vw"
                if (
                    roiname == "chanel_img000000_11"
                    or roiname == "chanel_img000000_12"
                ):
                    brand = "chanel"
                if (
                    roiname == "hyundai_img000146_2"
                    or roiname == "hyundai_img000199_0"
                    or roiname == "panasonic_img000143_2"
                    or roiname == "target_img000091_1"
                ):
                    brand = "chevrolet-symbol"
                if roiname == "hyundai_img000526_1":
                    brand = "citroen"
                if (
                    roiname == "esso_img000182_0"
                    or roiname == "red bull_img000194_1"
                    or roiname == "esso_img000101_3"
                    or roiname == "esso_img000107_1"
                ):
                    brand = "esso-text"
                if roiname == "red bull_img000298_2":
                    brand = "esso-symbol"
                if (
                    roiname == "hyundai_img000146_0"
                    or roiname == "kia_img000190_4"
                    or roiname == "starbucks_img000181_3"
                ):
                    brand = "honda-symbol"
                ...
                if (
                    brand == "heinekenn"
                    or brand == "heinekenn-text"
                    or brand == "heinekenn-würfel"
                    or brand == "heinekenn1"
                ):
                    brand = "heineken"
                if brand == "honda":
                ...
                if brand == "huawei":
                    brand = "huawei-text"
                if (
                    roiname == "coca-cola_img000671_5"
                    or roiname == "coca-cola_img000679_2"
                    or roiname == "coca-cola_img000698_1"
                    or roiname == "kia_img000236_4"
                    or roiname == "shell_img000153_5"
                ):
                ...
                if roiname == "boeing_img000015_0":
                    brand = "boeing-text"
                if (
                    roiname == "audi_img000444_3"
                    or roiname == "audi_img000444_4"
                ):
                    brand = "lexus-symbol"
                if brand == "lexus":
                    brand = "lexus-text"
                ...
                if brand == "malboro":
                    brand = "marlboro"
                if (
                    roiname == "McDonalds_img000233_2"
                    or roiname == "McDonalds_img000235_2"
                    or roiname == "McDonalds_img000202_2"
                    or roiname == "pepsi_img000338_0"
                    or roiname == "pizza hut_img000006_2"
                    or roiname == "pizza hut_img000026_0"
                    or roiname == "pizza hut_img000073_2"
                    or roiname == "pizza hut_img000118_2"
                    or roiname == "shell_img000330_1"
                    or roiname == "shell_img000354_1"
                    or roiname == "shell_img000361_1"
                ):
                    brand = "mcdonalds-text"
                ...
                if (
                    brand == "nissan"
                    or roiname == "BMW_img000207_0"
                    or roiname == "nissan_img000093_0"
                ):
                    brand = "nissan-symbol"
                if (
                    roiname == "kia_img000132_3"
                    or roiname == "kia_img000171_3"
                ):
                    brand = "nissan-text"
                if brand == "olympia":
                    brand = "olympicgames"
                if brand == "opel":
                    brand = "opel-symbol"
                if (
                    roiname == "kia_img000100_11"
                    or roiname == "kia_img000139_3"
                ):
                    brand = "opel-text"
                if brand == "oral-b":
                    brand = "oralb"
                ...
                if (
                    roiname == "santander_img000090_3"
                    or roiname == "shell_img000235_2"
                    or roiname == "shell_img000451_0"
                ):
                    brand = "ferrari"
                if (
                    roiname == "esso_img000280_2"
                    or roiname == "nissan_img000294_3"
                    or roiname == "nissan_img000298_5"
                    or roiname == "nissan_img000307_5"
                    or roiname == "nissan_img000333_6"
                ):
                ...
                if roiname == "volkswagen_img000625_4":
                    brand = "seat"
                if (
                    roiname == "budweiser_img000011_0"
                    or roiname == "budweiser_img000011_1"
                    or roiname == "budweiser_img000135_2"
                ):
                    brand = "budweiser-select-symbol"
                if (
                    brand == "shell"
                    or roiname == "shell_img000405_1"
                    or roiname == "shell_img000405_2"
                ):
                    brand = "shell-symbol"
                ...
                if brand == "siemens":
                    brand = "siemens-text"
                if (
                    roiname == "esso_img000108_0"
                    or roiname == "esso_img000158_1"
                ):
                    brand = "esso-text"
                if (
                    roiname == "costco_img000090_1"
                    or brand == "starbuckscoffe"
                    or brand == "starbuckscoffee"
                ):
                    brand = "starbucks-text"
                if (
                    roiname == "shell_img000354_4"
                    or roiname == "shell_img000361_2"
                    or brand == "starbucks-symbol+"
                    or brand == "starbucks-symbol+teilsichtbar"
                    or roiname == "starbucks_img000064_1"
                ):
                    brand = "starbucks-symbol"
                if (
                    roiname == "red bull_img000610_6"
                    or roiname == "red bull_img000610_7"
                ):
                    brand = "subaru-symbol"
                ...
                if brand == "toronto":
                    brand = "fctoronto"
                if (
                    roiname == "toyota_img000015_2"
                    or brand == "toyota-text1"
                    or brand == "toyota1"
                ):
                    brand = "toyota-text"
                ...
                if roiname == "kia_img000164_5":
                    brand = "volvo-symbol"
                if (
                    roiname == "gillette_img000371_1"
                    or roiname == "gillette_img000371_2"
                    or roiname == "gillette_img000371_3"
                ):
                ...
                if roiname == "pizza hut_img000144_3":
                    brand = "pizzahut"
                if (
                    roiname == "audi_img000150_3"
                    or roiname == "BMW_img000485_1"
                ):
                    brand = "deutschepost"
